...
4-20mA er en svært gammel standard og bevisst enkel og vanskelig å ødelegge: det er en strømsløyfe, så motstand i kabelen påvirker ikke avlesningen, og en brutt ledning er detekterbar (0mA betyr feil, ikke null). Men den har begrensninger:
...
SCADA-systemet poller PLSen og lagrer verdier i en historikk (historian), en tidsserie-database bygget for industrielle data. Historian-systemer bruker en teknikk kalt *unntaksrapportering* eller *deadbanding*: de lagrer bare en ny verdi hvis avlesningen har endret seg med mer enn en konfigurert terskel.
